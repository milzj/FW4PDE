...
https://github.com/OpenTidalFarm/OpenTidalFarm/blob/master/opentidalfarm/domains/rectangle_domain.py
...
- self._dx =
- self._ds =
- import dolfin -> from dolfin import *
...
class RectangularDomain(Domain):
    ...
    def __init__(self, x0, y0, x1, y1, nx, ny):
        ...
        self._ds = Measure('ds', domain=self.mesh, subdomain_data=self.facet_ids)
...
#        self._dx = Measure("dx")(subdomain_data=self.cell_ids)
        self._dx = Measure("dx", domain=self.mesh, subdomain_data = self.cell_ids)
